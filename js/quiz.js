const quizQuestions = [
...

    {
        ...
        options: [
            "Traduzir nomes para IPs",
            "Atribuir endereços IP automaticamente",
            "Ser a porta de saída para outras redes",
...
function showResult() {
    ...
    if (percentage >= 80) {
        ...
        message =
            "Excelente! Você domina muito bem os conceitos de redes.";
        ...
        message =
            "Bom trabalho! Você já tem uma base bem sólida.";
        ...
        message =
            "Você está no caminho certo. Vale revisar alguns pontos.";
